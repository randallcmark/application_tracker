...
- Document handling, Markdown rendering, source preservation, search, or export: `docs/DOCUMENT_HANDLING_STRATEGY.md`, `docs/DOCUMENT_HANDLING_ARCHITECTURE.md`, `docs/DOCUMENT_HANDLING_TASK_MAP.md`, `docs/SEARCH_AND_RETRIEVAL_DECISION.md`, and `docs/EXPORT_STRATEGY.md`.
